...
class Prediction_Data_validation:
    ...
    def valuesFromSchema(self):
        ...
        try:
            ...
            LengthOfDigitalStamp = dic['LengthOfDigitalStamp']
            column_names = dic['ColName']
            NumberofColumns = dic['NumberofColumns']

            file = open("Training_Logs/valuesfromSchemaValidationLog.txt", 'a+')
            message ="LengthOfDateStampInFile:: %s" %LengthOfDigitalStamp + "\t" + "NumberofColumns:: %s" % NumberofColumns + "\n"
        ...
        return LengthOfDigitalStamp, column_names, NumberofColumns
    ...
    def validationFileNameRaw(self,regex,LengthOfDigitalStamp):
        """
        ...
        try:
            ...
            for filename in onlyfiles:
                if (re.match(regex, filename)):
                    ...
                    if len(splitAtDot[1]) == LengthOfDigitalStamp:
